    ...
    >
      ...
      <div className="space-y-2 mb-3">
        <div className="flex items-center justify-between text-xs">
          ...
          {deal.priority === 'high' && (
            <Chip variant="danger" size="sm">High Priority</Chip>
          )}
        </div>
        ...
        {deal.competitorMentioned && (
          <div className="flex items-center space-x-1">
            ...
            <span className="text-xs text-warning">Competitor mentioned</span>
          </div>
        )}
      </div>
      ...
      {deal.tags && deal.tags.length > 0 && (
        <div className="flex flex-wrap gap-1">
          ...
          {deal.tags.length > 2 && (
            <Chip size="sm">+{deal.tags.length - 2}</Chip>
          )}
        </div>
      )}
    </Card>
      ...
      <Card className="p-4 mb-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center space-x-2">
            <span className={`w-2 h-2 rounded-full bg-current ${getStageColor(stage)}`} aria-hidden />
            <h3 className="font-semibold text-foreground text-sm">
              {getStageTitle(stage)}
            </h3>
            <Chip size="sm">{deals.length}</Chip>
          </div>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          {stageStats && (
            <Chip variant="info" size="sm">{stageStats.avgProbability}% AI</Chip>
          )}
        </div>
      </Card>
